...
These components can be connected together on a bread-board, or soldered more permanently on some type of perf-board. All prices are in Australian dollars (AUD).
...
- 1x [1.3" I^2^C OLED](https://www.aliexpress.com/w/wholesale-1.3-oled.html) (<$5)
...
- 1x [5V boost converter](https://zaitronics.com.au/products/mt3608-step-up-module) (<$3)
    - If using an adjustable boost converter, set the output to 5V using a multimeter. Lock the potentiometer in place with a dab of superglue
